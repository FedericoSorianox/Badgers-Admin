            ...
            <Modal.Body>
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    <Form.Group className="mb-2">
                        ...
                        <Form.Select name="tipo_cuota" value={formData.tipo_cuota || 'Libre - $2000'} onChange={handleChange} disabled={isViewOnly}>
                            <option value="Libre - $2000">Libre - $2000</option>
                            <option value="Solo Pesas - $800">Solo Pesas - $800</option>
                        </Form.Select>
                    </Form.Group>
                    <Form.Group className="mb-2">
                    ...
                    <Form.Group className="mb-2">
                        <Form.Label>Enfermedades/Alergias</Form.Label>
